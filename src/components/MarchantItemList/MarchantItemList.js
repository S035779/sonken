...
class MarchantItemList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      traded:  []
...
MarchantItemList.displayName = 'MarchantItemList';
MarchantItemList.defaultProps = { items: null }
MarchantItemList.propTypes = {
  classes: PropTypes.object.isRequired
};
export default withStyles(styles)(MarchantItemList);
