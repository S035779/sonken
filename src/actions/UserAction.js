...
export default {
  ...
  prefetchUsers(admin) {
    return UserApiClient.prefetchUsers(admin)
      .then(users => {
  ...
  fetchUsers(admin) {
    return UserApiClient.fetchUsers(admin)
      .then(users => {
  ...
  update(admin, user) {
    return UserApiClient.updateUser(admin, user)
      .then(() => {
  ...
  pagenation(admin, page) {
    return UserApiClient.pageUser(admin, page)
      .then(() => {
  ...
  select(admin, ids) {
    return UserApiClient.selectUser(admin, ids)
      .then(() => {
  ...
  delete(admin, ids) {
    return UserApiClient.deleteUser(admin, ids)
      .then(() => {
  ...
  sendmail(admin, ids) {
    return UserApiClient.sendmail(admin, ids)
      .then(() => {
  ...
  createApproval(admin, ids) {
    return UserApiClient.createApproval(admin, ids)
      .then(() => {
  ...
  deleteApproval(admin, ids) {
    return UserApiClient.deleteApproval(admin, ids)
      .then(() => {
  ...
  upload(admin, filename) {
    return UserApiClient.uploadNotes(admin, filename)
      .then(notes => {
  ...
  download(admin, filename) {
    return UserApiClient.downloadNotes(admin, filename)
      .then(notes => {
