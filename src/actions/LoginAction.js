...
export default {
  ...
  updatePreference(admin, data) {
    return LoginApiClient.updatePreference(admin, data)
      .then(preference => {
  ...
  createPreference(admin) {
    return LoginApiClient.createPreference(admin)
      .then(preference => {
  ...
  fetchProfile(admin) {
    return LoginApiClient.fetchProfile(admin)
      .then(profile => {
  ...
  confirmation(email, phone) {
    return LoginApiClient.confirmation(email, phone)
      .then(user => {
  ...
  changePassword(user, password) {
    return LoginApiClient.changePassword(user, password)
      .then(() => {
  ...
  registration(user, password, data) {
    return LoginApiClient.registration(user, password, data)
      .then(() => {
  ...
  inquiry(user, { title, body }) {
    return LoginApiClient.inquiry(user, { title, body })
      .then(() => {
