...
export default function getRoutes() {
  return [
    { path: '/', exact: true,     component: App, routes: [ 
      { component: Dashboard, loadData: getUserData } 
    ] }
  , { path: '/faqs',              component: Faqs, loadData: getUserData, routes: [
      { component: FaqsList } 
    ] }
  , { path: '/inquiry',           component: Inquiry, loadData: getUserData, routes: [ 
      { component: InquiryEdit } 
    ] }
  , { path: '/login/:page',       component: Auth, routes: [
      { component: Login, loadData: getUserData, routes: [
  ...
  , { path: '/admin/:category',   component: Admin, routes: [
      { path: '/admin/faq/:id',       component: Faq, loadData: getUserData, routes: [ 
        { path: '/admin/faq/:id/edit',      component: FaqEdit } 
      ] }
    , { path: '/admin/mail/:id',      component: Mail, loadData: getUserData, routes: [ 
        { path: '/admin/mail/:id/edit',     component: MailEdit } 
      ] }
    , { path: '/admin/:category/:id', component: Management, loadData: getUserData, routes: [ 
        { path: '/admin/users/:id/edit',    component: UserEdit     }
      , { path: '/admin/approval/:id/edit', component: ApprovalEdit } 
      ] }
    , { path: '/admin/faq',           component: Faq,         loadData: getUserData }
    , { path: '/admin/mail',          component: Mail,        loadData: getUserData }
    , { path: '/admin/:category',     component: Management,  loadData: getUserData } 
    ] }
