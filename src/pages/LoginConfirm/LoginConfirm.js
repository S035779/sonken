...
class LoginConfirm extends React.Component {
  ...
  render() {
    ...
    return <div className={classes.container}>
      ...
      <div className={classes.form}>
        <RssInput type="password" label="PHONE NUMBER" value={phone} placeholder="Phone number (Lower 4 digits)"
          onChange={this.handleChangeText.bind(this, 'phone')} className={classes.input} />
      </div>
      <div className={classes.form} />
      <div className={classes.buttons}>
        <div className={classes.space} />
        <RssButton color="secondary" onClick={this.handleSubmit.bind(this)}
